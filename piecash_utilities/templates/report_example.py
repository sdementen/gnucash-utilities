...
from piecash_utilities.report import report, RangeOption, DateOption, StringOption, execute_report, CommodityOption
...
def generate_report(
        ...
        a_cdty: CommodityOption(
            section="main",
            sort_tag="c",
            documentation_string="This is a commodity",
            default_value="(gnc-locale-default-iso-currency-code)"),
        a_date: DateOption(
            section="main",
            sort_tag="d",
